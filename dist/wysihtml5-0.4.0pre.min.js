...
window.rangy=function(){function a(a,b){var c=typeof a[b];return c==k||!(c!=h||!a[b])||"unknown"==c}function c(a,b){return!(typeof a[b]!=h||!a[b])}function b(a,b){return typeof a[b]!=n}function d(a){return function(b,c){for(var d=c.length;d--;)if(!a(b,c[d]))return!1;return!0}}function e(a){return a&&r(a,q)&&v(a,D)}function f(a){window.alert("Rangy not supported in your browser. Reason: "+a);t.initialized=!0;t.supported=!1}function g(){if(!t.initialized){var b,d=!1,k=!1;a(document,"createRange")&&
(b=document.createRange(),r(b,u)&&v(b,m)&&(d=!0),b.detach());(b=c(document,"body")?document.body:document.getElementsByTagName("body")[0])&&a(b,"createTextRange")&&(b=b.createTextRange(),e(b)&&(k=!0));d||k||f("Neither Range nor TextRange are implemented");t.initialized=!0;t.features={implementsDomRange:d,implementsTextRange:k};d=B.concat(x);k=0;for(b=d.length;k<b;++k)try{d[k](t)}catch(h){c(window,"console")&&a(window.console,"log")&&window.console.log("Init listener threw an exception. Continuing.",
h)}}}function l(a){this.name=a;this.supported=this.initialized=!1}var h="object",k="function",n="undefined",m="startContainer startOffset endContainer endOffset collapsed commonAncestorContainer START_TO_START START_TO_END END_TO_START END_TO_END".split(" "),u="setStart setStartBefore setStartAfter setEnd setEndBefore setEndAfter collapse selectNode selectNodeContents compareBoundaryPoints deleteContents extractContents cloneContents insertNode surroundContents cloneRange toString detach".split(" "),
...
t.fail=f;t.warn=function(a){a="Rangy warning: "+a;t.config.alertOnWarn?window.alert(a):typeof window.console!=n&&typeof window.console.log!=n&&window.console.log(a)};({}).hasOwnProperty?t.util.extend=function(a,b){for(var c in b)b.hasOwnProperty(c)&&(a[c]=b[c])}:f("hasOwnProperty not supported");var x=[],B=[];t.init=g;t.addInitListener=function(a){t.initialized?a(t):x.push(a)};var A=[];t.addCreateMissingNativeApiListener=function(a){A.push(a)};t.createMissingNativeApi=function(a){a=a||window;g();
for(var b=0,c=A.length;b<c;++b)A[b](a)};l.prototype.fail=function(a){this.initialized=!0;this.supported=!1;throw Error("Module '"+this.name+"' failed to load: "+a);};l.prototype.warn=function(a){t.warn("Module "+this.name+": "+a)};l.prototype.createError=function(a){return Error("Error in Rangy "+this.name+" module: "+a)};t.createModule=function(a,b){var c=new l(a);t.modules[a]=c;B.push(function(a){b(a,c);c.initialized=!0;c.supported=!0})};t.requireModules=function(a){for(var b=0,c=a.length,d,k;b<
c;++b){k=a[b];d=t.modules[k];if(!(d&&d instanceof l))throw Error("Module '"+k+"' not found");if(!d.supported)throw Error("Module '"+k+"' not supported");}};var F=!1,s=function(a){F||(F=!0,t.initialized||g())};if(typeof window==n)f("No window found");else if(typeof document==n)f("No document found");else return a(document,"addEventListener")&&document.addEventListener("DOMContentLoaded",s,!1),a(window,"addEventListener")?window.addEventListener("load",s,!1):a(window,"attachEvent")?window.attachEvent("onload",
s):f("Window does not have required addEventListener or attachEvent method"),t}();
rangy.createModule("DomUtil",function(a,c){function b(a){for(var b=0;a=a.previousSibling;)b++;return b}function d(a,b){var c=[],d;for(d=a;d;d=d.parentNode)c.push(d);for(d=b;d;d=d.parentNode)if(r(c,d))return d;return null}function e(a,b,c){for(c=c?a:a.parentNode;c;){a=c.parentNode;if(a===b)return c;c=a}return null}function f(a){a=a.nodeType;return 3==a||4==a||8==a}function g(a,b){var c=b.nextSibling,d=b.parentNode;c?d.insertBefore(a,c):d.appendChild(a);return a}function l(a){if(9==a.nodeType)return a;
if(typeof a.ownerDocument!=u)return a.ownerDocument;if(typeof a.document!=u)return a.document;if(a.parentNode)return l(a.parentNode);throw Error("getDocument: no document found for node");}function h(a){return a?f(a)?'"'+a.data+'"':1==a.nodeType?"<"+a.nodeName+(a.id?' id="'+a.id+'"':"")+">["+a.childNodes.length+"]":a.nodeName:"[No node]"}function k(a){this._next=this.root=a}function n(a,b){this.node=a;this.offset=b}function m(a){this.code=this[a];this.codeName=a;this.message="DOMException: "+this.codeName}
...
null}};n.prototype={equals:function(a){return this.node===a.node&this.offset==a.offset},inspect:function(){return"[DomPosition("+h(this.node)+":"+this.offset+")]"}};m.prototype={INDEX_SIZE_ERR:1,HIERARCHY_REQUEST_ERR:3,WRONG_DOCUMENT_ERR:4,NO_MODIFICATION_ALLOWED_ERR:7,NOT_FOUND_ERR:8,NOT_SUPPORTED_ERR:9,INVALID_STATE_ERR:11};m.prototype.toString=function(){return this.message};a.dom={arrayContains:r,isHtmlNamespace:function(a){var b;return typeof a.namespaceURI==u||null===(b=a.namespaceURI)||"http://www.w3.org/1999/xhtml"==
b},parentElement:function(a){a=a.parentNode;return 1==a.nodeType?a:null},getNodeIndex:b,getNodeLength:function(a){var b;return f(a)?a.length:(b=a.childNodes)?b.length:0},getCommonAncestor:d,isAncestorOf:function(a,b,c){for(b=c?b:b.parentNode;b;){if(b===a)return!0;b=b.parentNode}return!1},getClosestAncestorIn:e,isCharacterDataNode:f,insertAfter:g,splitDataNode:function(a,b){var c=a.cloneNode(!1);c.deleteData(0,b);a.deleteData(b,a.length-b);g(c,a);return c},getDocument:l,getWindow:function(a){a=l(a);
...
throw Error("getIframeWindow: No Document object found for iframe element");},getBody:function(a){return D.isHostObject(a,"body")?a.body:a.getElementsByTagName("body")[0]},getRootContainer:function(a){for(var b;b=a.parentNode;)a=b;return a},comparePoints:function(a,c,k,h){var f;if(a==k)return c===h?0:c<h?-1:1;if(f=e(k,a,!0))return c<=b(f)?-1:1;if(f=e(a,k,!0))return b(f)<h?-1:1;c=d(a,k);a=a===c?c:e(a,c,!0);k=k===c?c:e(k,c,!0);if(a===k)throw Error("comparePoints got to case 4 and childA and childB are the same!");
for(c=c.firstChild;c;){if(c===a)return-1;if(c===k)return 1;c=c.nextSibling}throw Error("Should not be here!");},inspectNode:h,fragmentFromNodeChildren:function(a){for(var b=l(a).createDocumentFragment(),c;c=a.firstChild;)b.appendChild(c);return b},createIterator:function(a){return new k(a)},DomPosition:n};a.DOMException=m});
rangy.createModule("DomRange",function(a,c){function b(a,b){return 3!=a.nodeType&&(p.isAncestorOf(a,b.startContainer,!0)||p.isAncestorOf(a,b.endContainer,!0))}function d(a){return p.getDocument(a.startContainer)}function e(a,b,c){if(b=a._listeners[b])for(var d=0,k=b.length;d<k;++d)b[d].call(a,{target:a,args:c})}function f(a){return new L(a.parentNode,p.getNodeIndex(a))}function g(a){return new L(a.parentNode,p.getNodeIndex(a)+1)}function l(a,b,c){var d=11==a.nodeType?a.firstChild:a;p.isCharacterDataNode(b)?
c==b.length?p.insertAfter(a,b):b.parentNode.insertBefore(a,0==c?b:p.splitDataNode(b,c)):c>=b.childNodes.length?b.appendChild(a):b.insertBefore(a,b.childNodes[c]);return d}function h(a){for(var b,c,k=d(a.range).createDocumentFragment();c=a.next();){b=a.isPartiallySelectedSubtree();c=c.cloneNode(!b);b&&(b=a.getSubtreeIterator(),c.appendChild(h(b)),b.detach(!0));if(10==c.nodeType)throw new G("HIERARCHY_REQUEST_ERR");k.appendChild(c)}return k}function k(a,b,c){var d,e;for(c=c||{stop:!1};d=a.next();)if(a.isPartiallySelectedSubtree())if(!1===
b(d)){c.stop=!0;break}else{if(d=a.getSubtreeIterator(),k(d,b,c),d.detach(!0),c.stop)break}else for(d=p.createIterator(d);e=d.next();)if(!1===b(e)){c.stop=!0;return}}function n(a){for(var b;a.next();)a.isPartiallySelectedSubtree()?(b=a.getSubtreeIterator(),n(b),b.detach(!0)):a.remove()}function m(a){for(var b,c=d(a.range).createDocumentFragment(),k;b=a.next();){a.isPartiallySelectedSubtree()?(b=b.cloneNode(!1),k=a.getSubtreeIterator(),b.appendChild(m(k)),k.detach(!0)):a.remove();if(10==b.nodeType)throw new G("HIERARCHY_REQUEST_ERR");
c.appendChild(b)}return c}function u(a,b,c){var d=!(!b||!b.length),e,h=!!c;d&&(e=RegExp("^("+b.join("|")+")$"));var f=[];k(new q(a,!1),function(a){d&&!e.test(a.nodeType)||h&&!c(a)||f.push(a)});return f}function D(a){return"["+("undefined"==typeof a.getName?"Range":a.getName())+"("+p.inspectNode(a.startContainer)+":"+a.startOffset+", "+p.inspectNode(a.endContainer)+":"+a.endOffset+")]"}function q(a,b){this.range=a;this.clonePartiallySelectedTextNodes=b;if(!a.collapsed){this.sc=a.startContainer;this.so=
a.startOffset;this.ec=a.endContainer;this.eo=a.endOffset;var c=a.commonAncestorContainer;this.sc===this.ec&&p.isCharacterDataNode(this.sc)?(this.isSingleCharacterDataNode=!0,this._first=this._last=this._next=this.sc):(this._first=this._next=this.sc!==c||p.isCharacterDataNode(this.sc)?p.getClosestAncestorIn(this.sc,c,!0):this.sc.childNodes[this.so],this._last=this.ec!==c||p.isCharacterDataNode(this.ec)?p.getClosestAncestorIn(this.ec,c,!0):this.ec.childNodes[this.eo-1])}}function r(a){this.code=this[a];
this.codeName=a;this.message="RangeException: "+this.codeName}function s(a,b,c){this.nodes=u(a,b,c);this._next=this.nodes[0];this._position=0}function v(a){return function(b,c){for(var d,k=c?b:b.parentNode;k;){d=k.nodeType;if(p.arrayContains(a,d))return k;k=k.parentNode}return null}}function t(a,b){if(da(a,b))throw new r("INVALID_NODE_TYPE_ERR");}function x(a){if(!a.startContainer)throw new G("INVALID_STATE_ERR");}function B(a,b){if(!p.arrayContains(b,a.nodeType))throw new r("INVALID_NODE_TYPE_ERR");
}function A(a,b){if(0>b||b>(p.isCharacterDataNode(a)?a.length:a.childNodes.length))throw new G("INDEX_SIZE_ERR");}function F(a,b){if(S(a,!0)!==S(b,!0))throw new G("WRONG_DOCUMENT_ERR");}function y(a){if(ea(a,!0))throw new G("NO_MODIFICATION_ALLOWED_ERR");}function C(a,b){if(!a)throw new G(b);}function J(a){return!p.arrayContains(X,a.nodeType)&&!S(a,!0)}function O(a,b){return b<=(p.isCharacterDataNode(a)?a.length:a.childNodes.length)}function z(a){x(a);if(J(a.startContainer)||J(a.endContainer)||!O(a.startContainer,
a.startOffset)||!O(a.endContainer,a.endOffset))throw Error("Range error: Range is no longer valid after DOM mutation ("+a.inspect()+")");}function I(){}function M(a){a.START_TO_START=T;a.START_TO_END=Y;a.END_TO_END=fa;a.END_TO_START=Z;a.NODE_BEFORE=$;a.NODE_AFTER=aa;a.NODE_BEFORE_AND_AFTER=ba;a.NODE_INSIDE=U}function P(a){M(a);M(a.prototype)}function N(a,b){return function(){z(this);var c=this.startContainer,d=this.startOffset,e=this.commonAncestorContainer,h=new q(this,!0);c!==e&&(c=p.getClosestAncestorIn(c,
e,!0),d=g(c),c=d.node,d=d.offset);k(h,y);h.reset();e=a(h);h.detach();b(this,c,d,c,d);return e}}function Q(c,d,k){function e(a,b){return function(c){x(this);B(c,K);B(R(c),X);c=(a?f:g)(c);(b?h:l)(this,c.node,c.offset)}}function h(a,b,c){var k=a.endContainer,e=a.endOffset;if(b!==a.startContainer||c!==a.startOffset){if(R(b)!=R(k)||1==p.comparePoints(b,c,k,e))k=b,e=c;d(a,b,c,k,e)}}function l(a,b,c){var k=a.startContainer,e=a.startOffset;if(b!==a.endContainer||c!==a.endOffset){if(R(b)!=R(k)||-1==p.comparePoints(b,
c,k,e))k=b,e=c;d(a,k,e,b,c)}}c.prototype=new I;a.util.extend(c.prototype,{setStart:function(a,b){x(this);t(a,!0);A(a,b);h(this,a,b)},setEnd:function(a,b){x(this);t(a,!0);A(a,b);l(this,a,b)},setStartBefore:e(!0,!0),setStartAfter:e(!1,!0),setEndBefore:e(!0,!1),setEndAfter:e(!1,!1),collapse:function(a){z(this);a?d(this,this.startContainer,this.startOffset,this.startContainer,this.startOffset):d(this,this.endContainer,this.endOffset,this.endContainer,this.endOffset)},selectNodeContents:function(a){x(this);
t(a,!0);d(this,a,0,a,p.getNodeLength(a))},selectNode:function(a){x(this);t(a,!1);B(a,K);var b=f(a);a=g(a);d(this,b.node,b.offset,a.node,a.offset)},extractContents:N(m,d),deleteContents:N(n,d),canSurroundContents:function(){z(this);y(this.startContainer);y(this.endContainer);var a=new q(this,!0),c=a._first&&b(a._first,this)||a._last&&b(a._last,this);a.detach();return!c},detach:function(){k(this)},splitBoundaries:function(){z(this);var a=this.startContainer,b=this.startOffset,c=this.endContainer,k=
this.endOffset,e=a===c;p.isCharacterDataNode(c)&&0<k&&k<c.length&&p.splitDataNode(c,k);p.isCharacterDataNode(a)&&0<b&&b<a.length&&(a=p.splitDataNode(a,b),e?(k-=b,c=a):c==a.parentNode&&k>=p.getNodeIndex(a)&&k++,b=0);d(this,a,b,c,k)},normalizeBoundaries:function(){z(this);var a=this.startContainer,b=this.startOffset,c=this.endContainer,k=this.endOffset,e=function(a){var b=a.nextSibling;b&&b.nodeType==a.nodeType&&(c=a,k=a.length,a.appendData(b.data),b.parentNode.removeChild(b))},h=function(d){var e=
d.previousSibling;if(e&&e.nodeType==d.nodeType){a=d;var h=d.length;b=e.length;d.insertData(0,e.data);e.parentNode.removeChild(e);a==c?(k+=b,c=a):c==d.parentNode&&(e=p.getNodeIndex(d),k==e?(c=d,k=h):k>e&&k--)}},f=!0;p.isCharacterDataNode(c)?c.length==k&&e(c):(0<k&&(f=c.childNodes[k-1])&&p.isCharacterDataNode(f)&&e(f),f=!this.collapsed);f?p.isCharacterDataNode(a)?0==b&&h(a):b<a.childNodes.length&&(e=a.childNodes[b])&&p.isCharacterDataNode(e)&&h(e):(a=c,b=k);d(this,a,b,c,k)},collapseToPoint:function(a,
b){x(this);t(a,!0);A(a,b);a===this.startContainer&&b===this.startOffset&&a===this.endContainer&&b===this.endOffset||d(this,a,b,a,b)}});P(c)}function H(a){a.collapsed=a.startContainer===a.endContainer&&a.startOffset===a.endOffset;a.commonAncestorContainer=a.collapsed?a.startContainer:p.getCommonAncestor(a.startContainer,a.endContainer)}function w(a,b,c,d,k){var h=a.startContainer!==b||a.startOffset!==c,f=a.endContainer!==d||a.endOffset!==k;a.startContainer=b;a.startOffset=c;a.endContainer=d;a.endOffset=
k;H(a);e(a,"boundarychange",{startMoved:h,endMoved:f})}function E(a){this.startContainer=a;this.startOffset=0;this.endContainer=a;this.endOffset=0;this._listeners={boundarychange:[],detach:[]};H(this)}a.requireModules(["DomUtil"]);var p=a.dom,L=p.DomPosition,G=a.DOMException;q.prototype={_current:null,_next:null,_first:null,_last:null,isSingleCharacterDataNode:!1,reset:function(){this._current=null;this._next=this._first},hasNext:function(){return!!this._next},next:function(){var a=this._current=
...
this.range)},getSubtreeIterator:function(){var a;if(this.isSingleCharacterDataNode)a=this.range.cloneRange(),a.collapse();else{a=new E(d(this.range));var b=this._current,c=b,k=0,e=b,h=p.getNodeLength(b);p.isAncestorOf(b,this.sc,!0)&&(c=this.sc,k=this.so);p.isAncestorOf(b,this.ec,!0)&&(e=this.ec,h=this.eo);w(a,c,k,e,h)}return new q(a,this.clonePartiallySelectedTextNodes)},detach:function(a){a&&this.range.detach();this.range=this._current=this._next=this._first=this._last=this.sc=this.so=this.ec=this.eo=
null}};r.prototype={BAD_BOUNDARYPOINTS_ERR:1,INVALID_NODE_TYPE_ERR:2};r.prototype.toString=function(){return this.message};s.prototype={_current:null,hasNext:function(){return!!this._next},next:function(){this._current=this._next;this._next=this.nodes[++this._position];return this._current},detach:function(){this._current=this._next=this.nodes=null}};var K=[1,3,4,5,7,8,10],X=[2,9,11],ga=[1,3,4,5,7,8,10,11],ha=[1,3,4,5,7,8],R=p.getRootContainer,S=v([9,11]),ea=v([5,6,10,12]),da=v([6,10,12]),ca=document.createElement("style"),
V=!1;try{ca.innerHTML="<b>x</b>",V=3==ca.firstChild.nodeType}catch(ia){}a.features.htmlParsingConforms=V;var W="startContainer startOffset endContainer endOffset collapsed commonAncestorContainer".split(" "),T=0,Y=1,fa=2,Z=3,$=0,aa=1,ba=2,U=3;I.prototype={attachListener:function(a,b){this._listeners[a].push(b)},compareBoundaryPoints:function(a,b){z(this);F(this.startContainer,b.startContainer);var c=a==Z||a==T?"start":"end",d=a==Y||a==T?"start":"end";return p.comparePoints(this[c+"Container"],this[c+
"Offset"],b[d+"Container"],b[d+"Offset"])},insertNode:function(a){z(this);B(a,ga);y(this.startContainer);if(p.isAncestorOf(a,this.startContainer,!0))throw new G("HIERARCHY_REQUEST_ERR");a=l(a,this.startContainer,this.startOffset);this.setStartBefore(a)},cloneContents:function(){z(this);var a,b;if(this.collapsed)return d(this).createDocumentFragment();if(this.startContainer===this.endContainer&&p.isCharacterDataNode(this.startContainer))return a=this.startContainer.cloneNode(!0),a.data=a.data.slice(this.startOffset,
this.endOffset),b=d(this).createDocumentFragment(),b.appendChild(a),b;b=new q(this,!0);a=h(b);b.detach();return a},canSurroundContents:function(){z(this);y(this.startContainer);y(this.endContainer);var a=new q(this,!0),c=a._first&&b(a._first,this)||a._last&&b(a._last,this);a.detach();return!c},surroundContents:function(a){B(a,ha);if(!this.canSurroundContents())throw new r("BAD_BOUNDARYPOINTS_ERR");var b=this.extractContents();if(a.hasChildNodes())for(;a.lastChild;)a.removeChild(a.lastChild);l(a,this.startContainer,
this.startOffset);a.appendChild(b);this.selectNode(a)},cloneRange:function(){z(this);for(var a=new E(d(this)),b=W.length,c;b--;)c=W[b],a[c]=this[c];return a},toString:function(){z(this);var a=this.startContainer;if(a===this.endContainer&&p.isCharacterDataNode(a))return 3==a.nodeType||4==a.nodeType?a.data.slice(this.startOffset,this.endOffset):"";var b=[],a=new q(this,!0);k(a,function(a){3!=a.nodeType&&4!=a.nodeType||b.push(a.data)});a.detach();return b.join("")},compareNode:function(a){z(this);var b=
a.parentNode,c=p.getNodeIndex(a);if(!b)throw new G("NOT_FOUND_ERR");a=this.comparePoint(b,c);b=this.comparePoint(b,c+1);return 0>a?0<b?ba:$:0<b?aa:U},comparePoint:function(a,b){z(this);C(a,"HIERARCHY_REQUEST_ERR");F(a,this.startContainer);return 0>p.comparePoints(a,b,this.startContainer,this.startOffset)?-1:0<p.comparePoints(a,b,this.endContainer,this.endOffset)?1:0},createContextualFragment:V?function(a){var b=this.startContainer,c=p.getDocument(b);if(!b)throw new G("INVALID_STATE_ERR");var d=null;
1==b.nodeType?d=b:p.isCharacterDataNode(b)&&(d=p.parentElement(b));d=null===d||"HTML"==d.nodeName&&p.isHtmlNamespace(p.getDocument(d).documentElement)&&p.isHtmlNamespace(d)?c.createElement("body"):d.cloneNode(!1);d.innerHTML=a;return p.fragmentFromNodeChildren(d)}:function(a){x(this);var b=d(this).createElement("body");b.innerHTML=a;return p.fragmentFromNodeChildren(b)},toHtml:function(){z(this);var a=d(this).createElement("div");a.appendChild(this.cloneContents());return a.innerHTML},intersectsNode:function(a,
b){z(this);C(a,"NOT_FOUND_ERR");if(p.getDocument(a)!==d(this))return!1;var c=a.parentNode,k=p.getNodeIndex(a);C(c,"NOT_FOUND_ERR");var e=p.comparePoints(c,k,this.endContainer,this.endOffset),c=p.comparePoints(c,k+1,this.startContainer,this.startOffset);return b?0>=e&&0<=c:0>e&&0<c},isPointInRange:function(a,b){z(this);C(a,"HIERARCHY_REQUEST_ERR");F(a,this.startContainer);return 0<=p.comparePoints(a,b,this.startContainer,this.startOffset)&&0>=p.comparePoints(a,b,this.endContainer,this.endOffset)},
intersectsRange:function(a,b){z(this);if(d(a)!=d(this))throw new G("WRONG_DOCUMENT_ERR");var c=p.comparePoints(this.startContainer,this.startOffset,a.endContainer,a.endOffset),k=p.comparePoints(this.endContainer,this.endOffset,a.startContainer,a.startOffset);return b?0>=c&&0<=k:0>c&&0<k},intersection:function(a){if(this.intersectsRange(a)){var b=p.comparePoints(this.startContainer,this.startOffset,a.startContainer,a.startOffset),c=p.comparePoints(this.endContainer,this.endOffset,a.endContainer,a.endOffset),
d=this.cloneRange();-1==b&&d.setStart(a.startContainer,a.startOffset);1==c&&d.setEnd(a.endContainer,a.endOffset);return d}return null},union:function(a){if(this.intersectsRange(a,!0)){var b=this.cloneRange();-1==p.comparePoints(a.startContainer,a.startOffset,this.startContainer,this.startOffset)&&b.setStart(a.startContainer,a.startOffset);1==p.comparePoints(a.endContainer,a.endOffset,this.endContainer,this.endOffset)&&b.setEnd(a.endContainer,a.endOffset);return b}throw new r("Ranges do not intersect");
},containsNode:function(a,b){return b?this.intersectsNode(a,!1):this.compareNode(a)==U},containsNodeContents:function(a){return 0<=this.comparePoint(a,0)&&0>=this.comparePoint(a,p.getNodeLength(a))},containsRange:function(a){return this.intersection(a).equals(a)},containsNodeText:function(a){var b=this.cloneRange();b.selectNode(a);var c=b.getNodes([3]);return 0<c.length?(b.setStart(c[0],0),a=c.pop(),b.setEnd(a,a.length),a=this.containsRange(b),b.detach(),a):this.containsNodeContents(a)},createNodeIterator:function(a,
b){z(this);return new s(this,a,b)},getNodes:function(a,b){z(this);return u(this,a,b)},getDocument:function(){return d(this)},collapseBefore:function(a){x(this);this.setEndBefore(a);this.collapse(!1)},collapseAfter:function(a){x(this);this.setStartAfter(a);this.collapse(!0)},getName:function(){return"DomRange"},equals:function(a){return E.rangesEqual(this,a)},inspect:function(){return D(this)}};Q(E,w,function(a){x(a);a.startContainer=a.startOffset=a.endContainer=a.endOffset=null;a.collapsed=a.commonAncestorContainer=
null;e(a,"detach",null);a._listeners=null});a.rangePrototype=I.prototype;E.rangeProperties=W;E.RangeIterator=q;E.copyComparisonConstants=P;E.createPrototypeRange=Q;E.inspect=D;E.getRangeDocument=d;E.rangesEqual=function(a,b){return a.startContainer===b.startContainer&&a.startOffset===b.startOffset&&a.endContainer===b.endContainer&&a.endOffset===b.endOffset};a.DomRange=E;a.RangeException=r});
rangy.createModule("WrappedRange",function(a,c){function b(a,b,c,d){var e=a.duplicate();e.collapse(c);var h=e.parentElement();f.isAncestorOf(b,h,!0)||(h=b);if(!h.canHaveHTML)return new g(h.parentNode,f.getNodeIndex(h));b=f.getDocument(h).createElement("span");var l,s=c?"StartToStart":"StartToEnd";do h.insertBefore(b,b.previousSibling),e.moveToElementText(b);while(0<(l=e.compareEndPoints(s,a))&&b.previousSibling);s=b.nextSibling;if(-1==l&&s&&f.isCharacterDataNode(s)){e.setEndPoint(c?"EndToStart":"EndToEnd",
...
l=f.isCharacterDataNode(a.node);l?(c=a.node,d=c.parentNode):(c=a.node.childNodes,c=e<c.length?c[e]:null,d=a.node);h=h.createElement("span");h.innerHTML="&#feff;";c?d.insertBefore(h,c):d.appendChild(h);g.moveToElementText(h);g.collapse(!b);d.removeChild(h);if(l)g[b?"moveStart":"moveEnd"]("character",e);return g}a.requireModules(["DomUtil","DomRange"]);var e,f=a.dom,g=f.DomPosition,l=a.DomRange;if(a.features.implementsDomRange&&(!a.features.implementsTextRange||!a.config.preferTextRange))(function(){function b(a){for(var c=
d.length,e;c--;)e=d[c],a[e]=a.nativeRange[e]}var c,d=l.rangeProperties,h;e=function(a){if(!a)throw Error("Range must be specified");this.nativeRange=a;b(this)};l.createPrototypeRange(e,function(a,b,c,d,e){var k=a.endContainer!==d||a.endOffset!=e;if(a.startContainer!==b||a.startOffset!=c||k)a.setEnd(d,e),a.setStart(b,c)},function(a){a.nativeRange.detach();a.detached=!0;for(var b=d.length,c;b--;)c=d[b],a[c]=null});c=e.prototype;c.selectNode=function(a){this.nativeRange.selectNode(a);b(this)};c.deleteContents=
...
c||(c=a.createNativeRange(r.getDocument(b.startContainer)),c.setEnd(b.endContainer,b.endOffset),c.setStart(b.startContainer,b.startOffset),b._selectionNativeRange=c,b.attachListener("detach",function(){this._selectionNativeRange=null}))):b instanceof t?c=b.nativeRange:a.features.implementsDomRange&&b instanceof r.getWindow(b.startContainer).Range&&(c=b);return c}function l(a){var b=a.getNodes(),c;a:if(b.length&&1==b[0].nodeType){c=1;for(var d=b.length;c<d;++c)if(!r.isAncestorOf(b[0],b[c])){c=!1;break a}c=
!0}else c=!1;if(!c)throw Error("getSingleElementFromRange: range "+a.inspect()+" did not consist of a single element");return b[0]}function h(a,b){var c=new t(b);a._ranges=[c];e(a,c,!1);a.rangeCount=1;a.isCollapsed=c.collapsed}function k(b){b._ranges.length=0;if("None"==b.docSelection.type)f(b);else{var c=b.docSelection.createRange();if(c&&"undefined"!=typeof c.text)h(b,c);else{b.rangeCount=c.length;for(var d,k=r.getDocument(c.item(0)),g=0;g<b.rangeCount;++g)d=a.createRange(k),d.selectNode(c.item(g)),
b._ranges.push(d);b.isCollapsed=1==b.rangeCount&&b._ranges[0].collapsed;e(b,b._ranges[b.rangeCount-1],!1)}}}function n(a,b){for(var c=a.docSelection.createRange(),d=l(b),e=r.getDocument(c.item(0)),e=r.getBody(e).createControlRange(),h=0,f=c.length;h<f;++h)e.add(c.item(h));try{e.add(d)}catch(g){throw Error("addRange(): Element within the specified Range could not be added to control selection (does it have layout?)");}e.select();k(a)}function m(a,b,c){this.nativeSelection=a;this.docSelection=b;this._ranges=
[];this.win=c;this.refresh()}function u(a,b){for(var c=r.getDocument(b[0].startContainer),c=r.getBody(c).createControlRange(),d=0,e;d<rangeCount;++d){e=l(b[d]);try{c.add(e)}catch(h){throw Error("setRanges(): Element within the one of the specified Ranges could not be added to control selection (does it have layout?)");}}c.select();k(a)}function D(a,b){if(a.anchorNode&&r.getDocument(a.anchorNode)!==r.getDocument(b))throw new x("WRONG_DOCUMENT_ERR");}function q(a){var b=[],c=new B(a.anchorNode,a.anchorOffset),
d=new B(a.focusNode,a.focusOffset),e="function"==typeof a.getName?a.getName():"Selection";if("undefined"!=typeof a.rangeCount)for(var h=0,k=a.rangeCount;h<k;++h)b[h]=v.inspect(a.getRangeAt(h));return"["+e+"(Ranges: "+b.join(", ")+")(anchor: "+c.inspect()+", focus: "+d.inspect()+"]"}a.requireModules(["DomUtil","DomRange","WrappedRange"]);a.config.checkSelectionRanges=!0;var r=a.dom,s=a.util,v=a.DomRange,t=a.WrappedRange,x=a.DOMException,B=r.DomPosition,A,F,y=a.util.isHostMethod(window,"getSelection"),
C=a.util.isHostObject(document,"selection"),J=C&&(!y||a.config.preferTextRange);J?(A=d,a.isSelectionValid=function(a){a=(a||window).document;var b=a.selection;return"None"!=b.type||r.getDocument(b.createRange().parentElement())==a}):y?(A=b,a.isSelectionValid=function(){return!0}):c.fail("Neither document.selection or window.getSelection() detected.");a.getNativeSelection=A;var y=A(),O=a.createNativeRange(document),z=r.getBody(document),I=s.areHostObjects(y,s.areHostProperties(y,["anchorOffset","focusOffset"]));
a.features.selectionHasAnchorAndFocus=I;var M=s.isHostMethod(y,"extend");a.features.selectionHasExtend=M;var P="number"==typeof y.rangeCount;a.features.selectionHasRangeCount=P;var N=!1,Q=!0;s.areHostMethods(y,["addRange","getRangeAt","removeAllRanges"])&&"number"==typeof y.rangeCount&&a.features.implementsDomRange&&function(){var a=document.createElement("iframe");z.appendChild(a);var b=r.getIframeDocument(a);b.open();b.write("<html><head></head><body>12</body></html>");b.close();var c=r.getIframeWindow(a).getSelection(),
d=b.documentElement.lastChild.firstChild,b=b.createRange();b.setStart(d,1);b.collapse(!0);c.addRange(b);Q=1==c.rangeCount;c.removeAllRanges();var e=b.cloneRange();b.setStart(d,0);e.setEnd(d,2);c.addRange(b);c.addRange(e);N=2==c.rangeCount;b.detach();e.detach();z.removeChild(a)}();a.features.selectionSupportsMultipleRanges=N;a.features.collapsedNonEditableSelectionsSupported=Q;var H=!1,w;z&&s.isHostMethod(z,"createControlRange")&&(w=z.createControlRange(),s.areHostProperties(w,["item","add"])&&(H=
!0));a.features.implementsControlRange=H;F=I?function(a){return a.anchorNode===a.focusNode&&a.anchorOffset===a.focusOffset}:function(a){return a.rangeCount?a.getRangeAt(a.rangeCount-1).collapsed:!1};var E;s.isHostMethod(y,"getRangeAt")?E=function(a,b){try{return a.getRangeAt(b)}catch(c){return null}}:I&&(E=function(b){var c=r.getDocument(b.anchorNode),c=a.createRange(c);c.setStart(b.anchorNode,b.anchorOffset);c.setEnd(b.focusNode,b.focusOffset);c.collapsed!==this.isCollapsed&&(c.setStart(b.focusNode,
b.focusOffset),c.setEnd(b.anchorNode,b.anchorOffset));return c});a.getSelection=function(a){a=a||window;var b=a._rangySelection,c=A(a),e=C?d(a):null;b?(b.nativeSelection=c,b.docSelection=e,b.refresh(a)):(b=new m(c,e,a),a._rangySelection=b);return b};a.getIframeSelection=function(b){return a.getSelection(r.getIframeWindow(b))};w=m.prototype;if(!J&&I&&s.areHostMethods(y,["removeAllRanges","addRange"])){w.removeAllRanges=function(){this.nativeSelection.removeAllRanges();f(this)};var p=function(b,c){var d=
v.getRangeDocument(c),d=a.createRange(d);d.collapseToPoint(c.endContainer,c.endOffset);b.nativeSelection.addRange(g(d));b.nativeSelection.extend(c.startContainer,c.startOffset);b.refresh()};w.addRange=P?function(b,c){if(H&&C&&"Control"==this.docSelection.type)n(this,b);else if(c&&M)p(this,b);else{var d;N?d=this.rangeCount:(this.removeAllRanges(),d=0);this.nativeSelection.addRange(g(b));this.rangeCount=this.nativeSelection.rangeCount;this.rangeCount==d+1?(a.config.checkSelectionRanges&&(d=E(this.nativeSelection,
this.rangeCount-1))&&!v.rangesEqual(d,b)&&(b=new t(d)),this._ranges[this.rangeCount-1]=b,e(this,b,K(this.nativeSelection)),this.isCollapsed=F(this)):this.refresh()}}:function(a,b){b&&M?p(this,a):(this.nativeSelection.addRange(g(a)),this.refresh())};w.setRanges=function(a){if(H&&1<a.length)u(this,a);else{this.removeAllRanges();for(var b=0,c=a.length;b<c;++b)this.addRange(a[b])}}}else if(s.isHostMethod(y,"empty")&&s.isHostMethod(O,"select")&&H&&J)w.removeAllRanges=function(){try{if(this.docSelection.empty(),
"None"!=this.docSelection.type){var a;if(this.anchorNode)a=r.getDocument(this.anchorNode);else if("Control"==this.docSelection.type){var b=this.docSelection.createRange();b.length&&(a=r.getDocument(b.item(0)).body.createTextRange())}a&&(a.body.createTextRange().select(),this.docSelection.empty())}}catch(c){}f(this)},w.addRange=function(a){"Control"==this.docSelection.type?n(this,a):(t.rangeToTextRange(a).select(),this._ranges[0]=a,this.rangeCount=1,this.isCollapsed=this._ranges[0].collapsed,e(this,
a,!1))},w.setRanges=function(a){this.removeAllRanges();var b=a.length;1<b?u(this,a):b&&this.addRange(a[0])};else return c.fail("No means of selecting a Range or TextRange was found"),!1;w.getRangeAt=function(a){if(0>a||a>=this.rangeCount)throw new x("INDEX_SIZE_ERR");return this._ranges[a]};var L;if(J)L=function(b){var c;a.isSelectionValid(b.win)?c=b.docSelection.createRange():(c=r.getBody(b.win.document).createTextRange(),c.collapse(!0));"Control"==b.docSelection.type?k(b):c&&"undefined"!=typeof c.text?
h(b,c):f(b)};else if(s.isHostMethod(y,"getRangeAt")&&"number"==typeof y.rangeCount)L=function(b){if(H&&C&&"Control"==b.docSelection.type)k(b);else if(b._ranges.length=b.rangeCount=b.nativeSelection.rangeCount,b.rangeCount){for(var c=0,d=b.rangeCount;c<d;++c)b._ranges[c]=new a.WrappedRange(b.nativeSelection.getRangeAt(c));e(b,b._ranges[b.rangeCount-1],K(b.nativeSelection));b.isCollapsed=F(b)}else f(b)};else if(I&&"boolean"==typeof y.isCollapsed&&"boolean"==typeof O.collapsed&&a.features.implementsDomRange)L=
function(a){var b;b=a.nativeSelection;b.anchorNode?(b=E(b,0),a._ranges=[b],a.rangeCount=1,b=a.nativeSelection,a.anchorNode=b.anchorNode,a.anchorOffset=b.anchorOffset,a.focusNode=b.focusNode,a.focusOffset=b.focusOffset,a.isCollapsed=F(a)):f(a)};else return c.fail("No means of obtaining a Range or TextRange from the user's selection was found"),!1;w.refresh=function(a){var b=a?this._ranges.slice(0):null;L(this);if(a){a=b.length;if(a!=this._ranges.length)return!1;for(;a--;)if(!v.rangesEqual(b[a],this._ranges[a]))return!1;
return!0}};var G=function(a,b){var c=a.getAllRanges(),d=!1;a.removeAllRanges();for(var e=0,h=c.length;e<h;++e)d||b!==c[e]?a.addRange(c[e]):d=!0;a.rangeCount||f(a)};w.removeRange=H?function(a){if("Control"==this.docSelection.type){var b=this.docSelection.createRange();a=l(a);for(var c=r.getDocument(b.item(0)),c=r.getBody(c).createControlRange(),d,e=!1,h=0,f=b.length;h<f;++h)d=b.item(h),d!==a||e?c.add(b.item(h)):e=!0;c.select();k(this)}else G(this,a)}:function(a){G(this,a)};var K;!J&&I&&a.features.implementsDomRange?
(K=function(a){var b=!1;a.anchorNode&&(b=1==r.comparePoints(a.anchorNode,a.anchorOffset,a.focusNode,a.focusOffset));return b},w.isBackwards=function(){return K(this)}):K=w.isBackwards=function(){return!1};w.toString=function(){for(var a=[],b=0,c=this.rangeCount;b<c;++b)a[b]=""+this._ranges[b];return a.join("")};w.collapse=function(b,c){D(this,b);var d=a.createRange(r.getDocument(b));d.collapseToPoint(b,c);this.removeAllRanges();this.addRange(d);this.isCollapsed=!0};w.collapseToStart=function(){if(this.rangeCount){var a=
this._ranges[0];this.collapse(a.startContainer,a.startOffset)}else throw new x("INVALID_STATE_ERR");};w.collapseToEnd=function(){if(this.rangeCount){var a=this._ranges[this.rangeCount-1];this.collapse(a.endContainer,a.endOffset)}else throw new x("INVALID_STATE_ERR");};w.selectAllChildren=function(b){D(this,b);var c=a.createRange(r.getDocument(b));c.selectNodeContents(b);this.removeAllRanges();this.addRange(c)};w.deleteFromDocument=function(){if(H&&C&&"Control"==this.docSelection.type){for(var a=this.docSelection.createRange(),
b;a.length;)b=a.item(0),a.remove(b),b.parentNode.removeChild(b);this.refresh()}else if(this.rangeCount){a=this.getAllRanges();this.removeAllRanges();b=0;for(var c=a.length;b<c;++b)a[b].deleteContents();this.addRange(a[c-1])}};w.getAllRanges=function(){return this._ranges.slice(0)};w.setSingleRange=function(a){this.setRanges([a])};w.containsNode=function(a,b){for(var c=0,d=this._ranges.length;c<d;++c)if(this._ranges[c].containsNode(a,b))return!0;return!1};w.toHtml=function(){var a="";if(this.rangeCount){for(var a=
v.getRangeDocument(this._ranges[0]).createElement("div"),b=0,c=this._ranges.length;b<c;++b)a.appendChild(this._ranges[b].cloneContents());a=a.innerHTML}return a};w.getName=function(){return"WrappedSelection"};w.inspect=function(){return q(this)};w.detach=function(){this.win=this.anchorNode=this.focusNode=this.win._rangySelection=null};m.inspect=q;a.Selection=m;a.selectionPrototype=w;a.addCreateMissingNativeApiListener(function(b){"undefined"==typeof b.getSelection&&(b.getSelection=function(){return a.getSelection(this)});
...
g=["constructor","toString","valueOf"],l=Base._prototyping?0:1;h=g[l++];)a[h]!=f[h]&&e.call(this,h,a[h]);for(var h in a)f[h]||e.call(this,h,a[h])}return this}};
...
(function(a){function c(a){return a.replace(e,function(a,b){var c=(b.match(f)||[])[1]||"",d=l[c];b=b.replace(f,"");b.split(d).length>b.split(c).length&&(b+=c,c="");var e=d=b;b.length>g&&(e=e.substr(0,g)+"...");"www."===d.substr(0,4)&&(d="http://"+d);return'<a href="'+d+'">'+e+"</a>"+c})}function b(h){if(!d.contains(h.nodeName))if(h.nodeType===a.TEXT_NODE&&h.data.match(e)){var k=h.parentNode,f=a.lang.string(h.data).escapeHTML(),g;g=k.ownerDocument;var l=g._wysihtml5_tempElement;l||(l=g._wysihtml5_tempElement=
g.createElement("div"));g=l;g.innerHTML="<span></span>"+c(f);for(g.removeChild(g.firstChild);g.firstChild;)k.insertBefore(g.firstChild,h);k.removeChild(h)}else{k=a.lang.array(h.childNodes).get();f=k.length;for(g=0;g<f;g++)b(k[g]);return h}}var d=a.lang.array("CODE PRE A SCRIPT HEAD TITLE STYLE".split(" ")),e=/((https?:\/\/|www\.)[^\s<]{3,})/gi,f=/([^\w\/\-](,?))$/i,g=100,l={")":"(","]":"[","}":"{"};a.dom.autoLink=function(a){var c;a:{c=a;for(var e;c.parentNode;){c=c.parentNode;e=c.nodeName;if(d.contains(e)){c=
...
wysihtml5.dom.convertToList=function(){function a(a,b){var d=a.createElement("li");b.appendChild(d);return d}return function(c,b){if("UL"===c.nodeName||"OL"===c.nodeName||"MENU"===c.nodeName)return c;var d=c.ownerDocument,e=d.createElement(b),f=c.querySelectorAll("br"),g=f.length,l,h,k,n,m;for(m=0;m<g;m++)for(l=f[m];(h=l.parentNode)&&h!==c&&h.lastChild===l;){if("block"===wysihtml5.dom.getStyle("display").from(h)){h.removeChild(l);break}wysihtml5.dom.insert(l).after(l.parentNode)}f=wysihtml5.lang.array(c.childNodes).get();
g=f.length;for(m=0;m<g;m++)n=n||a(d,e),l=f[m],h="block"===wysihtml5.dom.getStyle("display").from(l),k="BR"===l.nodeName,h?(n=n.firstChild?a(d,e):n,n.appendChild(l),n=null):k?n=n.firstChild?null:n:n.appendChild(l);0===f.length&&a(d,e);c.parentNode.replaceChild(e,c);return e}}();wysihtml5.dom.copyAttributes=function(a){return{from:function(c){return{to:function(b){for(var d,e=0,f=a.length;e<f;e++)d=a[e],"undefined"!==typeof c[d]&&""!==c[d]&&(b[d]=c[d]);return{andTo:arguments.callee}}}}}};
(function(a){var c=["-webkit-box-sizing","-moz-box-sizing","-ms-box-sizing","box-sizing"],b=function(b){var e;a:{e=0;for(var f=c.length;e<f;e++)if("border-box"===a.getStyle(c[e]).from(b)){e=c[e];break a}e=void 0}return e?parseInt(a.getStyle("width").from(b),10)<b.offsetWidth:!1};a.copyStyles=function(d){return{from:function(e){b(e)&&(d=wysihtml5.lang.array(d).without(c));for(var f="",g=d.length,l=0,h;l<g;l++)h=d[l],f+=h+":"+a.getStyle(h).from(e)+";";return{to:function(b){a.setStyles(f).on(b);return{andTo:arguments.callee}}}}}}})(wysihtml5.dom);
(function(a){a.dom.delegate=function(c,b,d,e){return a.dom.observe(c,d,function(d){for(var g=d.target,l=a.lang.array(c.querySelectorAll(b));g&&g!==c;){if(l.contains(g)){e.call(g,d);break}g=g.parentNode}})}})(wysihtml5);
...
wysihtml5.dom.getParentElement=function(){function a(a,b){return b&&b.length?"string"===typeof b?a===b:wysihtml5.lang.array(b).contains(a):!0}return function(c,b,d){d=d||50;if(b.className||b.classRegExp){a:{var e=b.nodeName,f=b.className;for(b=b.classRegExp;d--&&c&&"BODY"!==c.nodeName;){var g;if(g=c.nodeType===wysihtml5.ELEMENT_NODE)if(g=a(c.nodeName,e)){g=f;var l=(c.className||"").match(b)||[];g=g?l[l.length-1]===g:!!l.length}if(g)break a;c=c.parentNode}c=null}return c}a:{e=b.nodeName;for(f=d;f--&&
c&&"BODY"!==c.nodeName;){if(a(c.nodeName,e))break a;c=c.parentNode}c=null}return c}}();
wysihtml5.dom.getStyle=function(){function a(a){return a.replace(b,function(a){return a.charAt(1).toUpperCase()})}var c={"float":"styleFloat"in document.createElement("div").style?"styleFloat":"cssFloat"},b=/\-[a-z]/g;return function(b){return{from:function(e){if(e.nodeType===wysihtml5.ELEMENT_NODE){var f=e.ownerDocument,g=c[b]||a(b),l=e.style,h=e.currentStyle,k=l[g];if(k)return k;if(h)try{return h[g]}catch(n){}var g=f.defaultView||f.parentWindow,f=("height"===b||"width"===b)&&"TEXTAREA"===e.nodeName,
m;if(g.getComputedStyle)return f&&(m=l.overflow,l.overflow="hidden"),e=g.getComputedStyle(e,null).getPropertyValue(b),f&&(l.overflow=m||""),e}}}}}();wysihtml5.dom.hasElementWithTagName=function(){var a={},c=1;return function(b,d){var e=(b._wysihtml5_identifier||(b._wysihtml5_identifier=c++))+":"+d,f=a[e];f||(f=a[e]=b.getElementsByTagName(d));return 0<f.length}}();
...
wysihtml5.dom.observe=function(a,c,b){c="string"===typeof c?[c]:c;for(var d,e,f=0,g=c.length;f<g;f++)e=c[f],a.addEventListener?a.addEventListener(e,b,!1):(d=function(c){"target"in c||(c.target=c.srcElement);c.preventDefault=c.preventDefault||function(){this.returnValue=!1};c.stopPropagation=c.stopPropagation||function(){this.cancelBubble=!0};b.call(a,c)},a.attachEvent("on"+e,d));return{stop:function(){for(var e,h=0,k=c.length;h<k;h++)e=c[h],a.removeEventListener?a.removeEventListener(e,b,!1):a.detachEvent("on"+
e,d)}}};
wysihtml5.dom.parse=function(){function a(c,e){var h=c.childNodes,k=h.length,f=b[c.nodeType],g=0,n,f=f&&f(c);if(!f)return null;for(g=0;g<k;g++)(n=a(h[g],e))&&f.appendChild(n);if(e&&!(f.nodeName.toLowerCase()!==d||f.childNodes.length&&f.attributes.length)){for(h=f.ownerDocument.createDocumentFragment();f.firstChild;)h.appendChild(f.firstChild);return h}return f}function c(a,b){b=b.toLowerCase();var c;if(c="IMG"==a.nodeName)if(c="src"==b){var d;a:{try{d=a.complete&&!a.mozMatchesSelector(":-moz-broken");break a}catch(e){if(a.complete&&
"complete"===a.readyState){d=!0;break a}}d=void 0}c=!0===d}return c?a.src:l&&"outerHTML"in a?-1!=a.outerHTML.toLowerCase().indexOf(" "+b+"=")?a.getAttribute(b):null:a.getAttribute(b)}var b={1:function(a){var b,h,f=g.tags;h=a.nodeName.toLowerCase();b=a.scopeName;if(a._wysihtml5)return null;a._wysihtml5=1;if("wysihtml5-temp"===a.className)return null;b&&"HTML"!=b&&(h=b+":"+h);"outerHTML"in a&&(wysihtml5.browser.autoClosesUnclosedTags()||"P"!==a.nodeName||"</p>"===a.outerHTML.slice(-4).toLowerCase()||
(h="div"));if(h in f){b=f[h];if(!b||b.remove)return null;b="string"===typeof b?{rename_tag:b}:b}else if(a.firstChild)b={rename_tag:d};else return null;h=a.ownerDocument.createElement(b.rename_tag||h);var f={},l=b.set_class,s=b.add_class,v=b.set_attributes,t=b.check_attributes,x=g.classes,B=0,A=[];b=[];var F=[],y=[],C;v&&(f=wysihtml5.lang.object(v).clone());if(t)for(C in t)if(v=k[t[C]])v=v(c(a,C)),"string"===typeof v&&(f[C]=v);l&&A.push(l);if(s)for(C in s)if(v=n[s[C]])l=v(c(a,C)),"string"===typeof l&&
A.push(l);x["_wysihtml5-temp-placeholder"]=1;(y=a.getAttribute("class"))&&(A=A.concat(y.split(e)));for(s=A.length;B<s;B++)a=A[B],x[a]&&b.push(a);for(x=b.length;x--;)a=b[x],wysihtml5.lang.array(F).contains(a)||F.unshift(a);F.length&&(f["class"]=F.join(" "));for(C in f)try{h.setAttribute(C,f[C])}catch(J){}f.src&&("undefined"!==typeof f.width&&h.setAttribute("width",f.width),"undefined"!==typeof f.height&&h.setAttribute("height",f.height));return h},3:function(a){var b=a.nextSibling;if(b&&b.nodeType===
wysihtml5.TEXT_NODE)b.data=a.data+b.data;else return b=a.data.replace(h,""),a.ownerDocument.createTextNode(b)}},d="span",e=/\s+/,f={tags:{},classes:{}},g={},l=!wysihtml5.browser.supportsGetAttributeCorrectly(),h=/\uFEFF/g,k={url:function(){var a=/^https?:\/\//i;return function(b){return b&&b.match(a)?b.replace(a,function(a){return a.toLowerCase()}):null}}(),src:function(){var a=/^(\/|https?:\/\/)/i;return function(b){return b&&b.match(a)?b.replace(a,function(a){return a.toLowerCase()}):null}}(),href:function(){var a=
/^(\/|https?:\/\/|mailto:)/i;return function(b){return b&&b.match(a)?b.replace(a,function(a){return a.toLowerCase()}):null}}(),alt:function(){var a=/[^ a-z0-9_\-]/gi;return function(b){return b?b.replace(a,""):""}}(),numbers:function(){var a=/\D/g;return function(b){return(b=(b||"").replace(a,""))||null}}()},n={align_img:function(){var a={left:"wysiwyg-float-left",right:"wysiwyg-float-right"};return function(b){return a[String(b).toLowerCase()]}}(),align_text:function(){var a={left:"wysiwyg-text-align-left",
...
(function(a){function c(b){return"block"===a.getStyle("display").from(b)}function b(a){var b=a.ownerDocument.createElement("br");a.appendChild(b)}a.resolveList=function(a,e){if(a.nodeName.match(/^(MENU|UL|OL)$/)){var f=a.ownerDocument,g=f.createDocumentFragment(),l=a.previousElementSibling||a.previousSibling,h,k;if(e)for(l&&!c(l)&&b(g);k=a.firstElementChild||a.firstChild;){for(f=k.lastChild;l=k.firstChild;)h=(h=l===f)&&!c(l)&&"BR"!==l.nodeName,g.appendChild(l),h&&b(g);k.parentNode.removeChild(k)}else for(;k=
a.firstElementChild||a.firstChild;){if(k.querySelector&&k.querySelector("div, p, ul, ol, menu, blockquote, h1, h2, h3, h4, h5, h6"))for(;l=k.firstChild;)g.appendChild(l);else{for(h=f.createElement("p");l=k.firstChild;)h.appendChild(l);g.appendChild(h)}k.parentNode.removeChild(k)}a.parentNode.replaceChild(g,a)}}})(wysihtml5.dom);
...
frameborder:0,width:0,height:0,marginwidth:0,marginheight:0}).on(d);a.browser.throwsMixedContentWarningWhenIframeSrcIsEmpty()&&(d.src="javascript:'<html></html>'");d.onload=function(){d.onreadystatechange=d.onload=null;b._onLoadIframe(d)};d.onreadystatechange=function(){/loaded|complete/.test(d.readyState)&&(d.onreadystatechange=d.onload=null,b._onLoadIframe(d))};return d},_onLoadIframe:function(f){if(a.dom.contains(c.documentElement,f)){var g=this,l=f.contentWindow,h=f.contentWindow.document,k=this._getHtml({charset:c.characterSet||
c.charset||"utf-8",stylesheets:this.config.stylesheets});h.open("text/html","replace");h.write(k);h.close();this.getWindow=function(){return f.contentWindow};this.getDocument=function(){return f.contentWindow.document};l.onerror=function(a,b,c){throw Error("wysihtml5.Sandbox: "+a,b,c);};if(!a.browser.supportsSandboxedIframes()){var n,k=0;for(n=b.length;k<n;k++)this._unset(l,b[k]);k=0;for(n=d.length;k<n;k++)this._unset(l,d[k],a.EMPTY_FUNCTION);k=0;for(n=e.length;k<n;k++)this._unset(h,e[k]);this._unset(h,
"cookie","",!0)}this.loaded=!0;setTimeout(function(){g.callback(g)},0)}},_getHtml:function(b){var c=b.stylesheets,d="",e=0,k;if(c="string"===typeof c?[c]:c)for(k=c.length;e<k;e++)d+='<link rel="stylesheet" href="'+c[e]+'">';b.stylesheets=d;return a.lang.string('<!DOCTYPE html><html><head><meta charset="#{charset}">#{stylesheets}</head><body></body></html>').interpolate(b)},_unset:function(b,c,d,e){try{b[c]=d}catch(k){}try{b.__defineGetter__(c,function(){return d})}catch(n){}if(e)try{b.__defineSetter__(c,
function(){})}catch(m){}if(!a.browser.crashesWhenDefineProperty(c))try{var u={get:function(){return d}};e&&(u.set=function(){});Object.defineProperty(b,c,u)}catch(D){}}})})(wysihtml5);(function(){var a={className:"class"};wysihtml5.dom.setAttributes=function(c){return{on:function(b){for(var d in c)b.setAttribute(a[d]||d,c[d])}}}})();
...
wysihtml5.quirks.cleanPastedHTML=function(){var a={"a u":wysihtml5.dom.replaceWithChildNodes};return function(c,b,d){b=b||a;d=d||c.ownerDocument||document;var e="string"===typeof c,f,g,l,h=0;c=e?wysihtml5.dom.getAsDom(c,d):c;for(l in b)for(f=c.querySelectorAll(l),d=b[l],g=f.length;h<g;h++)d(f[h]);return e?c.innerHTML:c}}();
...
selectNode:function(b,d){var e=rangy.createRange(this.doc),f=b.nodeType===a.ELEMENT_NODE,g="canHaveHTML"in b?b.canHaveHTML:"IMG"!==b.nodeName,l=f?b.innerHTML:b.data,l=""===l||l===a.INVISIBLE_SPACE,h=c.getStyle("display").from(b),h="block"===h||"list-item"===h;if(l&&f&&g&&!d)try{b.innerHTML=a.INVISIBLE_SPACE}catch(k){}g?e.selectNodeContents(b):e.selectNode(b);g&&l&&f?e.collapse(h):g&&l&&(e.setStartAfter(b),e.setEndAfter(b));this.setSelection(e)},getSelectedNode:function(a){if(a&&this.doc.selection&&
"Control"===this.doc.selection.type&&(a=this.doc.selection.createRange())&&a.length)return a.item(0);a=this.getSelection(this.doc);return a.focusNode===a.anchorNode?a.focusNode:(a=this.getRange(this.doc))?a.commonAncestorContainer:this.doc.body},executeAndRestore:function(b,d){var e=this.doc.body,f=d&&e.scrollTop,g=d&&e.scrollLeft,l='<span class="_wysihtml5-temp-placeholder">'+a.INVISIBLE_SPACE+"</span>",h=this.getRange(this.doc),k;if(h){a.browser.hasInsertNodeIssue()?this.doc.execCommand("insertHTML",
!1,l):(l=h.createContextualFragment(l),h.insertNode(l));try{b(h.startContainer,h.endContainer)}catch(n){setTimeout(function(){throw n;},0)}(h=this.doc.querySelector("._wysihtml5-temp-placeholder"))?(l=rangy.createRange(this.doc),k=h.nextSibling,a.browser.hasInsertNodeIssue()&&k&&"BR"===k.nodeName?(k=this.doc.createTextNode(a.INVISIBLE_SPACE),c.insert(k).after(h),l.setStartBefore(k),l.setEndBefore(k)):(l.selectNode(h),l.deleteContents()),this.setSelection(l)):e.focus();d&&(e.scrollTop=f,e.scrollLeft=
g);try{h.parentNode.removeChild(h)}catch(m){}}else b(e,e)},executeAndRestoreSimple:function(a){var c,e,f=this.getRange(),g=this.doc.body,l;if(f){c=f.getNodes([3]);g=c[0]||f.startContainer;l=c[c.length-1]||f.endContainer;c=g===f.startContainer?f.startOffset:0;e=l===f.endContainer?f.endOffset:l.length;try{a(f.startContainer,f.endContainer)}catch(h){setTimeout(function(){throw h;},0)}a=rangy.createRange(this.doc);try{a.setStart(g,c)}catch(k){}try{a.setEnd(l,e)}catch(n){}try{this.setSelection(a)}catch(m){}}else a(g,
...
b.tagName.toLowerCase())&&d)return b;b=b.parentNode}return!1},postApply:function(a,b){for(var c=a[0],d=a[a.length-1],f=[],g,l=c,r=d,s=0,v=d.length,t,x,B=0,A=a.length;B<A;++B)t=a[B],(x=this.getAdjacentMergeableTextNode(t.parentNode,!1))?(g||(g=new e(x),f.push(g)),g.textNodes.push(t),t===c&&(l=g.firstTextNode,s=l.length),t===d&&(r=g.firstTextNode,v=g.getLength())):g=null;if(c=this.getAdjacentMergeableTextNode(d.parentNode,!0))g||(g=new e(d),f.push(g)),g.textNodes.push(c);if(f.length){B=0;for(A=f.length;B<
A;++B)f[B].doMerge();b.setStart(l,s);b.setEnd(r,v)}},getAdjacentMergeableTextNode:function(b,c){var d=b.nodeType==a.TEXT_NODE,e=d?b.parentNode:b,f=c?"nextSibling":"previousSibling";if(d){if((d=b[f])&&d.nodeType==a.TEXT_NODE)return d}else if((d=e[f])&&this.areElementsMergeable(b,d))return d[c?"firstChild":"lastChild"];return null},areElementsMergeable:function(a,b){var d;if(d=c.dom.arrayContains(this.tagNames,(a.tagName||"").toLowerCase()))if(d=c.dom.arrayContains(this.tagNames,(b.tagName||"").toLowerCase()))if(d=
a.className.replace(l," ")==b.className.replace(l," "))a:if(a.attributes.length!=b.attributes.length)d=!1;else{d=0;for(var e=a.attributes.length,f,g;d<e;++d)if(f=a.attributes[d],g=f.name,"class"!=g&&(g=b.attributes.getNamedItem(g),f.specified!=g.specified||f.specified&&f.nodeValue!==g.nodeValue)){d=!1;break a}d=!0}return d},createContainer:function(a){a=a.createElement(this.tagNames[0]);this.cssClass&&(a.className=this.cssClass);return a},applyToTextNode:function(a){var b=a.parentNode;1==b.childNodes.length&&
...
a.INVISIBLE_SPACE}catch(g){}b.selectNodeContents(c);f&&d?b.collapse(!1):f&&(b.setStartAfter(c),b.setEndAfter(c))},getTextSelectedByRange:function(a,b){var c=b.cloneRange();c.selectNodeContents(a);var d=c.intersection(b),d=d?d.toString():"";c.detach();return d},isAppliedToRange:function(b){var c=[],d,e=b.getNodes([a.TEXT_NODE]);if(!e.length)return(d=this.getAncestorWithClass(b.startContainer))?[d]:!1;for(var f=0,g=e.length,l;f<g;++f)if(l=this.getTextSelectedByRange(e[f],b),d=this.getAncestorWithClass(e[f]),
""==l||d)c.push(d);else return!1;return c},toggleRange:function(a){this.isAppliedToRange(a)?this.undoToRange(a):this.applyToRange(a)}};a.selection.HTMLApplier=f})(wysihtml5,rangy);
...
wysihtml5.commands.strikethrough={exec:function(a,c){return wysihtml5.commands.formatInline.exec(a,c,"del")},state:function(a,c){return wysihtml5.commands.formatInline.state(a,c,"del")}};
(function(a){function c(c,g){var l=c.doc,h="_wysihtml5-temp-"+ +new Date,k=0,n,m,u;a.commands.formatInline.exec(c,b,d,h,/non-matching-class/g);n=l.querySelectorAll(d+"."+h);for(h=n.length;k<h;k++)for(u in m=n[k],m.removeAttribute("class"),g)m.setAttribute(u,g[u]);k=m;1===h&&(u=e.getTextContent(m),h=!!m.querySelector("*"),u=""===u||u===a.INVISIBLE_SPACE,!h&&u&&(e.setTextContent(m,g.text||m.href),l=l.createTextNode(" "),c.selection.setAfter(m),e.insert(l).after(m),k=l));c.selection.setAfter(k)}var b,
...
c.substr(0,6)&&(b.className+=" "+e))});b.execCommand(c,!1,d);f&&f.stop()}function f(d,e){d.selection.selectLine();d.selection.surround(e);var f=b(e),g=c(e);f&&"BR"===f.nodeName&&f.parentNode.removeChild(f);g&&"BR"===g.nodeName&&g.parentNode.removeChild(g);(f=e.lastChild)&&"BR"===f.nodeName&&f.parentNode.removeChild(f);d.selection.selectNode(e,a.browser.displaysCaretInEmptyContentEditableCorrectly())}var g=a.dom,l="H1 H2 H3 H4 H5 H6 P BLOCKQUOTE DIV".split(" ");a.commands.formatBlock={exec:function(h,
k,n,m,u){var D=h.doc,q=this.state(h,k,n,m,u),r=h.config.useLineBreaks,s=r?"DIV":"P",v;n="string"===typeof n?n.toUpperCase():n;if(q)h.selection.executeAndRestoreSimple(function(){u&&(q.className=q.className.replace(u,""));if(a.lang.string(q.className).trim()||!r&&"P"!==n)g.renameElement(q,"P"===n?"DIV":s);else{var e=q,f=e.ownerDocument,h=b(e),k=c(e);h&&!d(h)&&e.parentNode.insertBefore(f.createElement("br"),h);k&&!d(k)&&e.parentNode.insertBefore(f.createElement("br"),e);g.replaceWithChildNodes(q)}});
else{if(null===n||a.lang.array(l).contains(n))if(v=h.selection.getSelectedNode(),q=g.getParentElement(v,{nodeName:l})){h.selection.executeAndRestore(function(){n&&(q=g.renameElement(q,n));if(m){var a=q;a.className?(a.className=a.className.replace(u,""),a.className+=" "+m):a.className=m}});return}h.commands.support(k)?e(D,k,n||s,m):(q=D.createElement(n||s),m&&(q.className=m),f(h,q))}},state:function(a,b,c,d,e){c="string"===typeof c?c.toUpperCase():c;a=a.selection.getSelectedNode();return g.getParentElement(a,
{nodeName:c,className:d,classRegExp:e})}}})(wysihtml5);
(function(a){function c(c,f,g){var l=c+":"+f;if(!d[l]){var h=d,k=a.selection.HTMLApplier,n=b[c];c=n?[c.toLowerCase(),n.toLowerCase()]:[c.toLowerCase()];h[l]=new k(c,f,g,!0)}return d[l]}var b={strong:"b",em:"i",b:"strong",i:"em"},d={};a.commands.formatInline={exec:function(a,b,d,l,h){b=a.selection.getRange();if(!b)return!1;c(d,l,h).toggleRange(b);a.selection.setSelection(b)},state:function(d,f,g,l,h){f=d.doc;var k=b[g]||g;return!a.dom.hasElementWithTagName(f,g)&&!a.dom.hasElementWithTagName(f,k)||
l&&!a.dom.hasElementWithClassName(f,l)?!1:(d=d.selection.getRange())?c(g,l,h).isAppliedToRange(d):!1}}})(wysihtml5);wysihtml5.commands.insertHTML={exec:function(a,c,b){a.commands.support(c)?a.doc.execCommand(c,!1,b):a.selection.insertHTML(b)},state:function(){return!1}};
...
!0):(a.innerHTML="<br>",e.selection.setBefore(a.firstChild))}});b.createsNestedInvalidMarkupAfterPaste()&&c.observe(this.element,"paste",function(b){b=e.doc.createTextNode(a.INVISIBLE_SPACE);e.selection.insertNode(b)});c.observe(this.doc,"keydown",function(b){var h=b.keyCode;if(!b.shiftKey&&(h===a.ENTER_KEY||h===a.BACKSPACE_KEY)){var k=c.getParentElement(e.selection.getSelectedNode(),{nodeName:f},4);k?setTimeout(function(){var b=e.selection.getSelectedNode(),f;if("LI"===k.nodeName){if(!b)return;(f=
c.getParentElement(b,{nodeName:g},2))||d(b)}h===a.ENTER_KEY&&k.nodeName.match(/^H[1-6]$/)&&d(b)},0):e.config.useLineBreaks&&h===a.ENTER_KEY&&!a.browser.insertsLineBreaksOnReturn()&&(e.commands.exec("insertLineBreak"),b.preventDefault())}})}})})(wysihtml5);
...
l=["html                 { height: 100%; }","body                 { height: 100%; padding: 1px 0 0 0; margin: -1px 0 0 0; }","body > p:first-child { margin-top: 0; }","._wysihtml5-temp     { display: none; }",a.browser.isGecko?"body.placeholder { color: graytext !important; }":"body.placeholder { color: #a9a9a9 !important; }","img:-moz-broken      { -moz-force-broken-image-icon: 1; height: 24px; width: 24px; }"],h=function(a){if(a.setActive)try{a.setActive()}catch(e){}else{var f=a.style,h=b.documentElement.scrollTop||
b.body.scrollTop,g=b.documentElement.scrollLeft||b.body.scrollLeft,f={position:f.position,top:f.top,left:f.left,WebkitUserSelect:f.WebkitUserSelect};c.setStyles({position:"absolute",top:"-99999px",left:"-99999px",WebkitUserSelect:"none"}).on(a);a.focus();c.setStyles(f).on(a);d.scrollTo&&d.scrollTo(g,h)}};a.views.Composer.prototype.style=function(){var d=this,n=b.querySelector(":focus"),m=this.textarea.element,u=m.hasAttribute("placeholder"),D=u&&m.getAttribute("placeholder"),q=m.style.display,r=m.disabled,
s;this.focusStylesHost=e.cloneNode(!1);this.blurStylesHost=e.cloneNode(!1);this.disabledStylesHost=e.cloneNode(!1);u&&m.removeAttribute("placeholder");m===n&&m.blur();m.disabled=!1;m.style.display=s="none";if(m.getAttribute("rows")&&"auto"===c.getStyle("height").from(m)||m.getAttribute("cols")&&"auto"===c.getStyle("width").from(m))m.style.display=s=q;c.copyStyles(g).from(m).to(this.iframe).andTo(this.blurStylesHost);c.copyStyles(f).from(m).to(this.element).andTo(this.blurStylesHost);c.insertCSS(l).into(this.element.ownerDocument);
m.disabled=!0;c.copyStyles(g).from(m).to(this.disabledStylesHost);c.copyStyles(f).from(m).to(this.disabledStylesHost);m.disabled=r;m.style.display=q;h(m);m.style.display=s;c.copyStyles(g).from(m).to(this.focusStylesHost);c.copyStyles(f).from(m).to(this.focusStylesHost);m.style.display=q;c.copyStyles(["display"]).from(m).to(this.iframe);var v=a.lang.array(g).without(["display"]);n?n.focus():m.blur();u&&m.setAttribute("placeholder",D);this.parent.on("focus:composer",function(){c.copyStyles(v).from(d.focusStylesHost).to(d.iframe);
...
d.parentNode.removeChild(d),setTimeout(function(){a.quirks.redraw(l)},0),b.preventDefault())});b.hasIframeFocusIssue()&&(c.observe(this.iframe,"focus",function(){setTimeout(function(){e.doc.querySelector(":focus")!==e.element&&e.focus()},0)}),c.observe(this.element,"blur",function(){setTimeout(function(){e.selection.getSelection().removeAllRanges()},0)}));var n={IMG:"Image: ",A:"Link: "};c.observe(l,"mouseover",function(a){a=a.target;var b=a.nodeName;"A"!==b&&"IMG"!==b||a.hasAttribute("title")||(b=
n[b]+(a.getAttribute("href")||a.getAttribute("src")),a.setAttribute("title",b))})}})(wysihtml5);
...
(function(a){var c=a.dom,b={position:"relative"},d={left:0,margin:0,opacity:0,overflow:"hidden",padding:0,position:"absolute",top:0,zIndex:1},e={cursor:"inherit",fontSize:"50px",height:"50px",marginTop:"-25px",outline:0,padding:0,position:"absolute",right:"-4px",top:"50%"},f={"x-webkit-speech":"",speech:""};a.toolbar.Speech=function(g,l){var h=document.createElement("input");if(a.browser.supportsSpeechApiOn(h)){var k=g.editor.textarea.element.getAttribute("lang");k&&(f.lang=k);k=document.createElement("div");
a.lang.object(d).merge({width:l.offsetWidth+"px",height:l.offsetHeight+"px"});c.insert(h).into(k);c.insert(k).into(l);c.setStyles(e).on(h);c.setAttributes(f).on(h);c.setStyles(d).on(k);c.setStyles(b).on(l);c.observe(h,"onwebkitspeechchange"in h?"webkitspeechchange":"speechchange",function(){g.execCommand("insertText",h.value);h.value=""});c.observe(h,"click",function(a){c.hasClass(l,"wysihtml5-command-disabled")&&a.preventDefault();a.stopPropagation()})}else l.style.display="none"}})(wysihtml5);
...
b+"]")).get(),e=c.length,f=0,g=this[b+"Mapping"]={},l,h,k,n,m;f<e;f++)l=c[f],k=l.getAttribute("data-wysihtml5-"+b),n=l.getAttribute("data-wysihtml5-"+b+"-value"),h=this.container.querySelector("[data-wysihtml5-"+b+"-group='"+k+"']"),m=this._getDialog(l,k),g[k+":"+n]={link:l,group:h,name:k,value:n,dialog:m,state:!1}},_getDialog:function(b,c){var e=this,f=this.container.querySelector("[data-wysihtml5-dialog='"+c+"']"),g,l;f&&(g=new a.toolbar.Dialog(b,f),g.on("show",function(){l=e.composer.selection.getBookmark();
e.editor.fire("show:dialog",{command:c,dialogContainer:f,commandLink:b})}),g.on("save",function(a){l&&e.composer.selection.setBookmark(l);e._execCommand(c,a);e.editor.fire("save:dialog",{command:c,dialogContainer:f,commandLink:b})}),g.on("cancel",function(){e.editor.focus(!1);e.editor.fire("cancel:dialog",{command:c,dialogContainer:f,commandLink:b})}));return g},execCommand:function(a,c){if(!this.commandsDisabled){var e=this.commandMapping[a+":"+c];e&&e.dialog&&!e.state?e.dialog.show():this._execCommand(a,
c)}},_execCommand:function(a,c){this.editor.focus(!1);this.composer.commands.exec(a,c);this._updateLinkStates()},execAction:function(a){var c=this.editor;"change_view"===a&&(c.currentView===c.textarea?c.fire("change_view","composer"):c.fire("change_view","textarea"))},_observe:function(){for(var a=this,d=this.editor,e=this.container,f=this.commandLinks.concat(this.actionLinks),g=f.length,l=0;l<g;l++)if("A"===f[l].nodeName)c.setAttributes({href:"javascript:;",unselectable:"on"}).on(f[l]);else c.setAttributes({unselectable:"on"}).on(f[l]);
