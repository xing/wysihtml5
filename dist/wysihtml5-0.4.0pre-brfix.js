    ...
    _initParser: function() {
      this.on("paste:composer", function() {
        ...
        that.composer.selection.executeAndRestore(function() {
          ...
          // todo fixme - jch feb16 2013 - dirty hack to fix trailing br on paste problem, see https://github.com/xing/wysihtml5/issues/142
          if (that.composer.element.innerHTML) {
            // remove trailing br, first inside then outside of final para
            // this fix requires current useLineBreaks settings
            that.composer.element.innerHTML = that.composer.element.innerHTML.replace(/(<br>)+(<\/p>)$/, '</p>').replace(/(<br>)+$/, '');  
          }
