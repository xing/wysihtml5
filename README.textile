...
h2. Modifications by me 

Now, in the toolbar you can add an embed iframe video with two differentes ways. You can insert the source video and its size (width + height) or put its all embed code directly using the option *insert embed code*.

*IMPORTANT NOTE:* I have to split each new code to its right place to do a make complete and succesfully (and tested). Right now, the modified code is in wysithml5-0.2.0.js and the example about how to use it in advanced.html
...
* "@raulbarrosoleon":http://www.raulbarroso.com